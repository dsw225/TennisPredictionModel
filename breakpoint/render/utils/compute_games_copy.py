...
async def create_new_game_df(game, players_elo, player_surface_elos):
    ...
    game_entry = [
        ...
        a_player_elos['recent_elo_rating'],
        a_player_elos['recent_point_elo_rating'],
        a_player_elos['recent_game_elo_rating'],
        a_player_elos['recent_set_elo_rating'],
        a_player_elos['recent_service_game_elo_rating'],
        a_player_elos['recent_return_game_elo_rating'],
        a_player_elos['recent_tie_break_elo_rating'],
        a_surface_elos['recent_elo_rating'],
        a_surface_elos['recent_point_elo_rating'],
        a_surface_elos['recent_game_elo_rating'],
        a_surface_elos['recent_set_elo_rating'],
        a_surface_elos['recent_service_game_elo_rating'],
        a_surface_elos['recent_return_game_elo_rating'],
        a_surface_elos['recent_tie_break_elo_rating'],

        b_player_elos['recent_elo_rating'],
        b_player_elos['recent_point_elo_rating'],
        b_player_elos['recent_game_elo_rating'],
        b_player_elos['recent_set_elo_rating'],
        b_player_elos['recent_service_game_elo_rating'],
        b_player_elos['recent_return_game_elo_rating'],
        b_player_elos['recent_tie_break_elo_rating'],
        b_surface_elos['recent_elo_rating'],
        b_surface_elos['recent_point_elo_rating'],
        b_surface_elos['recent_game_elo_rating'],
        b_surface_elos['recent_set_elo_rating'],
