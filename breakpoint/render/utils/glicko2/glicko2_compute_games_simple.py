...
async def prior_games(df: pd.DataFrame, enddate: datetime.date):
    ...
    new_header = ['player', 'last_date', 'match_number', 'matches_played', 'glicko_rating', 'point_glicko_rating', 'game_glicko_rating', 
                  'set_glicko_rating', 'service_game_glicko_rating', 'return_game_glicko_rating', 'tie_break_glicko_rating']
...
async def create_new_game_df(game, players_glicko, player_surface_glickos):
    ...
    game_entry = [
        ...
        '',
        player_b_rank,
        a_player_glickos['glicko_rating'],
        a_player_glickos['point_glicko_rating'],
        a_player_glickos['game_glicko_rating'],
        a_player_glickos['set_glicko_rating'],
        a_player_glickos['service_game_glicko_rating'],
        a_player_glickos['return_game_glicko_rating'],
        a_player_glickos['tie_break_glicko_rating'],
        a_surface_glickos['glicko_rating'],
        a_surface_glickos['point_glicko_rating'],
        a_surface_glickos['game_glicko_rating'],
        a_surface_glickos['set_glicko_rating'],
        a_surface_glickos['service_game_glicko_rating'],
        a_surface_glickos['return_game_glicko_rating'],
        a_surface_glickos['tie_break_glicko_rating'],
        ...
        0,  # Placeholder, calculate as needed
        0,  # Placeholder, calculate as needed
        b_player_glickos['glicko_rating'],
        b_player_glickos['point_glicko_rating'],
        b_player_glickos['game_glicko_rating'],
        b_player_glickos['set_glicko_rating'],
        b_player_glickos['service_game_glicko_rating'],
        b_player_glickos['return_game_glicko_rating'],
        b_player_glickos['tie_break_glicko_rating'],
        b_surface_glickos['glicko_rating'],
        b_surface_glickos['point_glicko_rating'],
        b_surface_glickos['game_glicko_rating'],
        b_surface_glickos['set_glicko_rating'],
        b_surface_glickos['service_game_glicko_rating'],
        b_surface_glickos['return_game_glicko_rating'],
        b_surface_glickos['tie_break_glicko_rating'],
        0,  # Placeholder, calculate as needed
        0,  # Placeholder, calculate as needed
        0,  # Placeholder, calculate as needed
        0,  # Placeholder, calculate as needed
