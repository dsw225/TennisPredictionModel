...
# RETURN LATER
# class FullElo(models.Model):
#     #last_date,match_number,matches_played,elo_rating,set_elo_rating,game_elo_rating,service_game_elo_rating,return_game_elo_rating,tie_break_elo_rating
#     player_id = models.IntegerField(max_length=50)
#     player_name = models.CharField(max_length=100)
#     player_last_game = models.DateField()
#     player_matches_played = models.IntegerField()
#     player_elo = models.IntegerField(max_length=4)
